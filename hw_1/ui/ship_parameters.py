...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMaximumSize(QSize(420, 250))
        self.verticalLayout = QVBoxLayout(Form)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.groupBox = QGroupBox(Form)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setStyleSheet(u"font: 12pt \"Segoe UI\";")
        ...
        self.label.setMinimumSize(QSize(165, 0))

        self.horizontalLayout_2.addWidget(self.label)

        self.lineEdit = QLineEdit(self.groupBox)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setStyleSheet(u"color: rgb(255, 194, 97);")
        ...
        self.label_2.setMinimumSize(QSize(165, 0))
        ...
        self.label_3.setMinimumSize(QSize(165, 0))
        ...
        self.label_4.setMinimumSize(QSize(165, 0))
        ...
        self.label_5.setMinimumSize(QSize(165, 0))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"ship_parameters", None))
