...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentIndexChanged.connect(self.onComboBoxCurrentIndexChanged)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        ...
        self.dateTimeEdit.dateChanged.connect(self.onDateTimeEditDateChanged)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def onComboBoxCurrentIndexChanged(self, index: int) -> None:
        ...
        self.plainTextEditLog.setPlainText(self.comboBox.itemText(index))
    ...
    def onDateTimeEditDateChanged(self, date: QtCore.QDate) -> None:
        """
        Обработка сигнала dateChanged для dateTimeEdit

        :param date: новая дата
        :return: None
        """

        self.plainTextEditLog.setPlainText(date.toString())
